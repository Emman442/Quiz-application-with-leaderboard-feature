...
function WalletSection() {
  ...
  const balance = useBalance({
    address: userHasWallet(userContext) ? userContext.walletAddress.toString() : undefined,
  });
        ...
        <div>
          ...
          {userHasWallet(userContext) && (
            <>
              ...
              {isConnected ? <p>Wallet is connected</p> : <button onClick={connectExistingWallet}>Connect Wallet</button>}
            </>
          )}
        </div>
      )}
